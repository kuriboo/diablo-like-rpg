/**
 * placeholders/EffectGenerator.js - エフェクト生成機能
 * 
 ...
 */
export function createEffectPlaceholders(scene, placeholders) {
  // 攻撃エフェクト
 ...
 * @param {Object} placeholders - プレースホルダーオブジェクト
 */
export function createAttackEffect(scene, key, color, placeholders) {
 ...
 * @param {Object} placeholders - プレースホルダーオブジェクト
 */
export function createHealEffect(scene, key, color, placeholders) {
  const graphics = scene.add.graphics();
  const size = 64;
 ...
 * @param {Object} placeholders - プレースホルダーオブジェクト
 */
export function createMagicEffect(scene, key, color, placeholders) {
  const graphics = scene.add.graphics();
  const size = 64;
 ...
 * @param {Object} placeholders - プレースホルダーオブジェクト
 */
export function createParticle(scene, key, color, placeholders) {
  const graphics = scene.add.graphics();
  const size = 8;
