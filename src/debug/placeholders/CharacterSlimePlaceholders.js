/**
 * placeholders/CharacterSlime.js - スライムキャラクター描画機能
 * 
 ...
 */
export function drawSlimeCharacter(graphics, color, width, height, variant, details, direction, animation, customFeatures = {}) {
  // デフォルトのカスタマイズオプション
  const defaults = {
 ...
 * 通常のスライムを描画
 */
export function drawNormalSlime(graphics, color, centerX, centerY, bodyWidth, bodyHeight, squishX, squishY, features, details, direction) {
  // 底部の影
  graphics.fillStyle(0x000000, 0.2);
  drawEllipse(
    graphics,
 ...
 * 金属スライムを描画
 */
export function drawMetalSlime(graphics, color, centerX, centerY, bodyWidth, bodyHeight, squishX, squishY, features, details, direction) {
  // 金属スライムの体
 ...
 * 属性スライムを描画
 */
export function drawElementalSlime(graphics, color, centerX, centerY, bodyWidth, bodyHeight, squishX, squishY, features, details, direction) {
  // 外側の薄いオーラ
 ...
 * 王様スライムを描画
 */
export function drawKingSlime(graphics, color, centerX, centerY, bodyWidth, bodyHeight, squishX, squishY, features, details, direction) {
  // 王様スライムの体
  graphics.fillStyle(color, features.transparency);
  drawEllipse(
    graphics,
 ...
 * スライムの顔を描画
 */
export function drawSlimeFace(graphics, centerX, centerY, bodyWidth, bodyHeight, features, details, direction) {
  // 目のサイズと間隔
 ...
 */
export function drawEllipseExtended(graphics, x, y, radiusX, radiusY, outline = false, fill = true) {
  if (outline) {
